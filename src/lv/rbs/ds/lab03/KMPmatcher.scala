...
class KMPmatcher(pattern:String) {
  ...
  def findAllIn(text:CharSequence):Iterator[Int] ={
    ...
    //initialize offset value for the case if the first elements match
...
//initialize start and offset values for the case if the first elements match
  ...
  def toJson(text: CharSequence): String={
    ...
    val steps:List[List[Int]] = findAllSteps(text)
    ...
    for(elem<- steps){
      ...
      //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      //for testing purposes the json dictionary contained not match-> true but rather match-> 1
      //if there is a match - so I used the exact function with  this replacement toJsonTest
      //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      if(elem(3) == 1){
